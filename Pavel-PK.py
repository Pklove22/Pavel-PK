...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Pklove22/Approval-.txt/blob/main/Approval%20.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Pk love22/Approval-.txt/blob/main/Approval%20.txt').text
			if basesplit in plr:
				key = basesplit
